...
parser.add_argument(
    "-i", "--input", type=str, default="input.mkv", help="input file name"
)
parser.add_argument(
    "-s", "--subs", type=str, default="ass", help="subtitle file format"
)
...
# no subs
os.system(
    f"vspipe -c y4m inference_batch.py - | mpv - --audio-file={audio_path} --demuxer-max-bytes={args.cache}"
)
# subs
